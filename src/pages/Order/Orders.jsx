...
const Orders = () => {
  ...
  const columns = [
    { accessorKey: "invoice_no", header: "Numéro de facture" },
    { accessorKey: "customer_name", header: "Nom du client" },
    // {
    //   accessorKey: "order_status",
    //   header: "Order Status",
    //   Cell: ({ cell }) => {
    ...
    // },
    {
      ...
      // No need for a custom Cell renderer since we're formatting the date in the useEffect
    },
    {
      accessorKey: "payment_type",
      header: "Type de paiement",
